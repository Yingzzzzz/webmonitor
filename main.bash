...
# Ready to make .csv output      
       sed 's/Address//g' Finallogtranstart.csv > Finallogtranstart.csv
        sed 's/Address//g' Finallogtranend.csv > Finallogtranend.csv
       sed 's/Address//g' netlog.txt > netK.txt
       sed 's/Address//g' Finallog.txt > Finallogshort.txt
      
       sed -e 's/[[:space:]][[:space:]]*/ /g' Finallogtranstart.csv > Finallogtranstart.csv
       sed -e 's/[[:space:]][[:space:]]*/ /g' Finallogtranend.csv > Finallogtranend.csv
       ...
       sed -i 's/\s\+/,/g' Finallogtranstart.csv
        sed -i 's/\s\+/,/g' Finallogtranend.csv
